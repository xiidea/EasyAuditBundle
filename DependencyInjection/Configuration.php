...
class Configuration implements ConfigurationInterface
{
    ...
    private function addRequiredConfigs(ArrayNodeDefinition $rootNode)
    {
        $rootNode
            ->children()
                ...
                ->scalarNode('document_class')->cannotBeOverwritten()->isRequired()->cannotBeEmpty()->end()
            ->end();
    }
    ...
    private function addDefaultServices(ArrayNodeDefinition $rootNode)
    {
        $rootNode
            ->children()
                ...
                ->scalarNode('document_event_resolver')
                    ->defaultValue('xiidea.easy_audit.default_document_event_resolver')
                ->end()
    ...
    private function addOptionalConfigs(ArrayNodeDefinition $rootNode)
    {
        $rootNode
            ->children()
                ->variableNode('doctrine_documents')->defaultValue(array())->end()
